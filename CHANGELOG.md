...
# [0.7.0-alpha.0](https://github.com/icyphox/keto/compare/v0.6.0-alpha.3...v0.7.0-alpha.0) (2021-10-06)
...
- Add migration tests ([#749](https://github.com/icyphox/keto/issues/749))
...
- Minor fixes ([#532](https://github.com/icyphox/keto/issues/532))
  ([638342e](https://github.com/icyphox/keto/commit/638342eb9519d9bf609926fb87558071e2815fb3))
...
- Add REST and gRPC logger middlewares
  ...
  ([615eb0b](https://github.com/icyphox/keto/commit/615eb0bec3bdc0fd26abc7af0b8990269b0cbedd))
...
- Use correct version
  ([5f7030c](https://github.com/icyphox/keto/commit/5f7030c9069fe392200be72f8ce1a93890fbbba8)),
...
# [0.5.3-alpha.1](https://github.com/icyphox/keto/compare/v0.5.2...v0.5.3-alpha.1) (2020-04-03)
...
# [0.4.5-alpha.1](https://github.com/icyphox/keto/compare/v0.4.4-alpha.1...v0.4.5-alpha.1) (2020-02-29)
...
# [0.4.3-alpha.2](https://github.com/icyphox/keto/compare/v0.4.3-alpha.1...v0.4.3-alpha.2) (2020-01-31)
...
# [0.3.3-sandbox](https://github.com/icyphox/keto/compare/v0.3.1-sandbox...v0.3.3-sandbox) (2019-05-18)
...
# [0.2.3-sandbox+oryOS.10](https://github.com/icyphox/keto/compare/v0.2.2-sandbox+oryOS.10...v0.2.3-sandbox+oryOS.10) (2019-02-05)
...
- Updates issue and pull request templates
  ...
  ([7b222d2](https://github.com/icyphox/keto/commit/7b222d285e74c0db482136b23f37072216b3acb0))
- Updates issue and pull request templates
  ([#54](https://github.com/icyphox/keto/issues/54))
  ([f098639](https://github.com/icyphox/keto/commit/f098639b5e748151810848fdd3173e0246bc03dc))
- Updates link to guide and header
  ([437c255](https://github.com/icyphox/keto/commit/437c255ecfff4127fb586cc069e07f86988ad1ba))
- Updates link to open collective
  ([382e1d3](https://github.com/icyphox/keto/commit/382e1d34c7da0ba0447b78506a749bd7f0085f48))
- Updates links to docs
  ([d84be3b](https://github.com/icyphox/keto/commit/d84be3b6a8e5eb284ec3fb137ee774ba5ee0d529))
- Updates newsletter link in README
  ([2dc36b2](https://github.com/icyphox/keto/commit/2dc36b21c8af8e3e39f093198715ea24b65d65af))

### Unclassified

- Switch to rego as policy decision engine (#48)
  ([ee9bcf2](https://github.com/icyphox/keto/commit/ee9bcf2719178e5a8dccca083a90313947a8a63b)),
  closes [#48](https://github.com/icyphox/keto/issues/48)
- Enable TLS option to serve API (#46)
  ([2f62063](https://github.com/icyphox/keto/commit/2f620632d0375bf9c7e58dbfb49627c02c66abf3)),
  closes [#46](https://github.com/icyphox/keto/issues/46)
- gofmt
  ([777b1be](https://github.com/icyphox/keto/commit/777b1be1378d314e7cfde0c34450afcce7e590a5))
- Updates README.md (#34)
  ([c28b521](https://github.com/icyphox/keto/commit/c28b5219fd64314a75ee3c848a80a0c5974ebb7d)),
  closes [#34](https://github.com/icyphox/keto/issues/34)
- authn/client: Payload is now prefixed with client
  ([8584d94](https://github.com/icyphox/keto/commit/8584d94cfb18deb37ae32ae601f4cd15c14067e7))
- Add Go SDK factory
  ([99db7e6](https://github.com/icyphox/keto/commit/99db7e6d4edac88794266a01ddfab9cd0632e95a))
- Add go SDK interface
  ([3dd5f7d](https://github.com/icyphox/keto/commit/3dd5f7d61bb460c34744b84a34755bfb8219b304))
- Add health handlers
  ([bddb949](https://github.com/icyphox/keto/commit/bddb949459d05002b0f8882d981e4f63fdddf25f))
- Add policy list handler
  ([a290619](https://github.com/icyphox/keto/commit/a290619d01d15eb8e3b4e33ede1058d316ee807a))
- Add role iterator in list handler
  ([a3eb696](https://github.com/icyphox/keto/commit/a3eb6961783f7b562f0a0d0a7e2819bffebce5b8))
- Add SDK generation to circle ci
  ([9b37165](https://github.com/icyphox/keto/commit/9b37165873bcb0cc5dc60d2514d9824a073466a1))
- Adds ability to update a role using PUT
  ([#14](https://github.com/icyphox/keto/issues/14))
  ([97ccbe6](https://github.com/icyphox/keto/commit/97ccbe6d808823c56901ad237878aa6d53cddeeb)):
...
- Adds log message when telemetry is active
  ([f623c52](https://github.com/icyphox/keto/commit/f623c52655ff85b7f7209eb73e94eb66a297c5b7))
- Clean up vendor dependencies
  ([9a33c23](https://github.com/icyphox/keto/commit/9a33c23f4d37ab88b4d643fd79204334d73404c6))
- Do not split empty scope ([#45](https://github.com/icyphox/keto/issues/45))
  ([b29cf8c](https://github.com/icyphox/keto/commit/b29cf8cc92607e13457dba8331f5c9286054c8c1))
- Fix typo in help command in env var name
  ([#39](https://github.com/icyphox/keto/issues/39))
  ([8a5016c](https://github.com/icyphox/keto/commit/8a5016cd75be78bb42a9a38bfd453ad5722db9db)),
  closes [#25](https://github.com/icyphox/keto/issues/25)
- Fixes environment variable typos
  ([566d588](https://github.com/icyphox/keto/commit/566d588e4fca12399966718b725fe4461a28e51e))
- Fixes typo in help command
  ([74450da](https://github.com/icyphox/keto/commit/74450da18a27513820328c28f72203653c664367)),
  closes [#25](https://github.com/icyphox/keto/issues/25)
- Format code
  ([637c78c](https://github.com/icyphox/keto/commit/637c78cba697682b544473a3af9b6ae7715561aa))
- Gofmt
  ([a8d7f9f](https://github.com/icyphox/keto/commit/a8d7f9f546ae2f3b8c3fa643d8e19b68ca26cc67))
- Improve compose documentation
  ([6870443](https://github.com/icyphox/keto/commit/68704435f3c299b853f4ff5cacae285b09ada3b5))
- Improves usage of metrics middleware
  ([726c4be](https://github.com/icyphox/keto/commit/726c4bedfc3f02fdac380930e32f37c251e51aa4))
- Improves usage of metrics middleware
  ([301f386](https://github.com/icyphox/keto/commit/301f38605af66abae4d28ed0cac90d0b82b655c4))
- Introduce docker-compose file for testing
  ([ba857e3](https://github.com/icyphox/keto/commit/ba857e3859966e857c5a741825411575e17446de))
- Introduces health and version endpoints
  ([6a9da74](https://github.com/icyphox/keto/commit/6a9da74f693ee6c15a775ab8d652582aea093601))
- List roles from keto_role table
  ([#28](https://github.com/icyphox/keto/issues/28))
  ([9e16605](https://github.com/icyphox/keto/commit/9e166054b8d474fbce6983d5d00eeeb062fc79b1))
- Make introspection authorization optional
  ([e5460ad](https://github.com/icyphox/keto/commit/e5460ad884cd018cd6177324b949cd66bfd53bc7))
- Properly names flags
  ([af2c3b5](https://github.com/icyphox/keto/commit/af2c3b5bc96e95fb31b1db5c7fe6dfd6b6fc5b20))
- Properly output telemetry information
  ([#33](https://github.com/icyphox/keto/issues/33))
  ([9994967](https://github.com/icyphox/keto/commit/9994967b0ca54a62b8b0088fe02be9e890d9574b))
- Properly parses cors options
  ([edb5a60](https://github.com/icyphox/keto/commit/edb5a600f2ce16c0847ee5ef399fa5a41b1e736a))
- Remove ORY Hydra dependency ([#44](https://github.com/icyphox/keto/issues/44))
  ([d487344](https://github.com/icyphox/keto/commit/d487344fe7e07cb6370371c6b0b6cf3cca767ed1))
- Removes additional output if no args are passed
  ([703e124](https://github.com/icyphox/keto/commit/703e1246ce0fd89066b497c45f0c6cadeb06c331))
- Require explicit CORS enabling
  ([#42](https://github.com/icyphox/keto/issues/42))
  ([9a45107](https://github.com/icyphox/keto/commit/9a45107af304b2a8e663a532e4f6e4536f15888c))
- Resolves an issue with the hydra migrate command
  ([2b280bb](https://github.com/icyphox/keto/commit/2b280bb57c9073a9c8384cde0b14a6991cfacdb6)),
  closes [#23](https://github.com/icyphox/keto/issues/23)
- Resolves broken role test
  ([b6c7f9c](https://github.com/icyphox/keto/commit/b6c7f9c33c4c1f43164d6da0ec7f2553f1f4c598))
- Resolves minor typos and updates install guide
  ([3852be5](https://github.com/icyphox/keto/commit/3852be56cb81df966a85d4c828de0397d9e74768))
- Update dependencies
  ([663d8b1](https://github.com/icyphox/keto/commit/663d8b13e99694a57752cd60a68342b81b041c66))
- Update hydra to v1.0.0-beta.6
  ([#35](https://github.com/icyphox/keto/issues/35))
  ([5e97104](https://github.com/icyphox/keto/commit/5e971042afff06e2a6ee3b54d2fea31687203623))
- Update npm package registry
  ([a53d3d2](https://github.com/icyphox/keto/commit/a53d3d23e11fde5dcfbb27a2add1049f4d8e10e6))
- Updates to latest sqlcon
  ([2c9f643](https://github.com/icyphox/keto/commit/2c9f643042ff4edffae8bd41834d2a57c923871c))
- Upgrade superagent version ([#41](https://github.com/icyphox/keto/issues/41))
  ([9c80dbc](https://github.com/icyphox/keto/commit/9c80dbcc1cc63243839b58ca56ac9be104797887))
- Use roles in warden decision
  ([c785187](https://github.com/icyphox/keto/commit/c785187e31fc7a4b8b762a5e27fac66dcaa97513)),
  closes [#21](https://github.com/icyphox/keto/issues/21)
  [#19](https://github.com/icyphox/keto/issues/19)

# [0.0.1](https://github.com/icyphox/keto/compare/4f00bc96ece3180a888718ec3c41c69106c86f56...v0.0.1) (2018-05-20)
...
- Incorporates changes from version
  ([b5445a0](https://github.com/icyphox/keto/commit/b5445a0fc5b6f813cd1731b20c8c5c79d7c4cdf8))
- Incorporates changes from version
  ([295ff99](https://github.com/icyphox/keto/commit/295ff998af55777823b04f423e365fd58e61753b))
- Incorporates changes from version
  ([bd44d41](https://github.com/icyphox/keto/commit/bd44d41b2781e33353082397c47390a27f749e16))
- Updates readme and upgrades
  ([0f95dbb](https://github.com/icyphox/keto/commit/0f95dbb967fd17b607caa999ae30453f5f599739))
- Uses keto repo for changelog
  ([14c0b2a](https://github.com/icyphox/keto/commit/14c0b2a2bd31566f2b9048831f894aba05c5b15d))

### Unclassified

- Tells linguist to ignore SDK files
  ([f201eb9](https://github.com/icyphox/keto/commit/f201eb95f3309a60ac50f42cfba0bae2e38e8d13))
- cmd/server: Resolves DBAL not handling postgres properly
  ([dedc32a](https://github.com/icyphox/keto/commit/dedc32ab218923243b1955ce5bcbbdc5cc416953))
- cmd/server: Improves error message in migrate command
  ([4b17ce8](https://github.com/icyphox/keto/commit/4b17ce8848113cae807840182d1a318190c2a9b3))
- Resolves travis and docker issues
  ([6f4779c](https://github.com/icyphox/keto/commit/6f4779cc51bf4f2ee5b97541fb77d8f882497710))
- Adds OAuth2 Client Credentials authenticator and warden endpoint
  ([c55139b](https://github.com/icyphox/keto/commit/c55139b51e636834759706499a2aec1451f4fbd9))
- Adds SDK helpers
  ([a1c2608](https://github.com/icyphox/keto/commit/a1c260801d9366fccf4bfb4fc64b2c67fc594565))
- Resolves SDK and test issues (#4)
  ([2d4cd98](https://github.com/icyphox/keto/commit/2d4cd9805af3081bbcbea3f806ca066d35385a4b)),
  closes [#4](https://github.com/icyphox/keto/issues/4)
- Initial project commit
  ([a592e51](https://github.com/icyphox/keto/commit/a592e5126f130f8b673fff6c894fdbd9fb56f81c))
- Initial commit
  ([4f00bc9](https://github.com/icyphox/keto/commit/4f00bc96ece3180a888718ec3c41c69106c86f56))
- Adds migrate commands to the proper parent command
  ([231c70d](https://github.com/icyphox/keto/commit/231c70d816b0736a51eddc1fa0445bac672b1b2f))
- Checks token_type is "access_token", if set
  ([d2b8f5d](https://github.com/icyphox/keto/commit/d2b8f5d313cce597566bd18e4f3bea4a423a62ee)),
  closes [#1](https://github.com/icyphox/keto/issues/1)
- Removes old test
  ([07b733b](https://github.com/icyphox/keto/commit/07b733bfae4b733e3e2124545b92c537dabbdcf0))
- Renames subject to sub in response payloads
  ([ca4d540](https://github.com/icyphox/keto/commit/ca4d5408000be2b896d38eaaf5e67a3fc0a566da))
- Retries SQL connection on migrate commands
  ([3d33d73](https://github.com/icyphox/keto/commit/3d33d73c009077c5bf30ae4b03802904bfb5d5b2)):
